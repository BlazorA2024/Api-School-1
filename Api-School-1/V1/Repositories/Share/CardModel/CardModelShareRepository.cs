...
{
    /// <summary>
    /// CardModel class for ShareRepository.
    /// </summary>
    public class CardModelShareRepository : BaseShareRepository<CardModelRequestShareDto, CardModelResponseShareDto, CardModelRequestBuildDto, CardModelResponseBuildDto>, ICardModelShareRepository
    {
        // Declare the builder repository.
        private readonly CardModelBuilderRepository _builder;
        /// <summary>
        /// Constructor for CardModelShareRepository.
        /// </summary>
        public CardModelShareRepository(DataContext dbContext, IMapper mapper, ILoggerFactory logger) : base(mapper, logger)
        {
            // Initialize the builder repository.
            _builder = new CardModelBuilderRepository(dbContext, mapper, logger.CreateLogger(typeof(CardModelShareRepository).FullName));
        ...
        /// </summary>
        public override async Task<CardModelResponseShareDto> CreateAsync(CardModelRequestShareDto entity)
        {
            try
            {
        ...
        /// </summary>
        public override async Task<IEnumerable<CardModelResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override async Task<CardModelResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override IQueryable<CardModelResponseShareDto> GetQueryable()
        {
            try
            {
                _logger.LogInformation("Retrieving IQueryable<CardModelResponseShareDto> for CardModel entities...");
        ...
        public Task SaveChangesAsync()
        {
            try
            {
                _logger.LogInformation("Saving changes to the database for CardModel entities...");
                throw new NotImplementedException();
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error in SaveChangesAsync for CardModel entities.");
        ...
        /// </summary>
        public override async Task<CardModelResponseShareDto> UpdateAsync(CardModelRequestShareDto entity)
        {
            try
            {
        ...
        public override async Task<PagedResponse<CardModelResponseShareDto>> GetAllAsync(string[]? includes = null, int pageNumber = 1, int pageSize = 10)
        {
            try
            {
                ...
                return new PagedResponse<CardModelResponseShareDto>(items, results.PageNumber, results.PageSize, results.TotalPages);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error while fetching all CardModels.");
                return new PagedResponse<CardModelResponseShareDto>(new List<CardModelResponseShareDto>(), pageNumber, pageSize, 0);
            }
        }

        public override async Task<CardModelResponseShareDto?> GetByIdAsync(object id)
        {
            try
            {
        ...
        public override async Task DeleteRange(List<CardModelRequestShareDto> entities)
        {
            try
            {
                var builddtos = entities.OfType<CardModelRequestBuildDto>().ToList();
        ...
        public override async Task<PagedResponse<CardModelResponseShareDto>> GetAllByAsync(List<FilterCondition> conditions, ParamOptions? options = null)
        {
            try
            {
                _logger.LogInformation("[Share]Retrieving  CardModel entities as pagination...");
                return MapToPagedResponse(await _builder.GetAllByAsync(conditions, options));
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "[Share]Error in GetAllByAsync for CardModel entities as pagination.");
                return null;
            }
        }

        public override async Task<CardModelResponseShareDto?> GetOneByAsync(List<FilterCondition> conditions, ParamOptions? options = null)
        {
            try
            {
                _logger.LogInformation("[Share]Retrieving CardModel entity...");
                return MapToShareResponseDto(await _builder.GetOneByAsync(conditions, options));
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "[Share]Error in GetOneByAsync  for CardModel entity.");
                return null;
            }
        }
    }
